...
How many phases are left in the project? What are the phases and the sub-phases? 
...
Does this solution also ensure that the row vector is set up with hooks, and that the hooks have been pre-trained, and that they're working correctly? If not, it should. 
