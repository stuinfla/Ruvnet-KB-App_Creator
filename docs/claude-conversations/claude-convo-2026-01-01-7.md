...
Great. Score the current knowledge base for me and tell me how good and how deep you believe it is on a scale from 1 to 100 across all the different categories based on what our goal is. 


## Human

I want you to read through the skill and the plan, and let me know just how effective you think this is. Rate it from 1 to 100. How useful is this as the core architecture for building out world-class knowledge bases, and then turning them into world-class agent-based applications that fully use all that knowledge and provide something that is a phenomenal user experience?

Where are there still missing elements? Is it complete? Is it comprehensive? Is this the right thing? Are we doing all the right elements? Is it easy to follow? Is there any reason to believe that if we apply it on a brownfield application, that you would skip any of the stuff?

'Cause the first time I went to use it, you skipped a bunch of stuff and made assumptions that the database was good, or the knowledge base was good, therefore, violating the first level. In addition, it's very important that we get extremely explicit on phase seven and phase eight, and I want to know how many sub-phases there are to each one.

So can you please lay that out for me clearly? 
...
All right, figure out what it takes to get this thing to 98 out of 100. 
